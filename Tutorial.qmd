...
subtitle: "A quick into to generating interpretable graphs"
author: Norm Matloff
toc: true
---
...
Whoa!  One of the factors underlying this nonmonotonicity may be age
discrimination. 
...
The Primary case is surprisingly bimodal, so we should be suspicious.
Is it due to having a small sample size for that case?  Let's check:
...
No, boys seem to be somewhat ahead from the start.
...
Illustration of the color gradient in the census data: Probability
customer exits, given balance and number of products they use.
...
The following may seem to be just a mathematical
